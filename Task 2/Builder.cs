...
namespace Builder
{
    class Program
    {
        ...
        {
            public override void BuildDough() { pizza.SetDough("amazing"); }
            public override void BuildSauce() { pizza.SetSauce("mild"); }
            public override void BuildTopping() { pizza.SetTopping("ham"); }
        }
        class Waiter
        {
        ...
        class BuilderExample
        {
            public static void Main(String[] args)
            {
                ...
                var margaritaPizzaBuilder = new MargaritaPizzaBuilder();
